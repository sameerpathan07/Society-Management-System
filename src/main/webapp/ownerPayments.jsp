...
<option disabled selected>Select Flat</option>
<%try{
	String flatno=request.getParameter("flatno");
	System.out.println("Flat Name: "+flatno);
...
ResultSet rs=ps.executeQuery();
	...
	{
  %>
<table  id='tblPayment' border=1 style=''>
<tr>
<td><label>Maintenace:</label></td>
<td><%=rs.getString("maitainence_ID") %></td>
</tr>
<tr>
